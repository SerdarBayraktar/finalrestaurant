...
export default class Tutorial extends Component {
  constructor(props) {
    ...
    this.onChangebrough = this.onChangebrough.bind(this);
  ...
  updateTutorial() {
    const data = {
      ...
      cuisine: this.state.currentTutorial.cuisine,
      borough: this.state.currentTutorial.borough,
